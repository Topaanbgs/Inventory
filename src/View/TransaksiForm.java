...
public class TransaksiForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama", "Tanggal Peminjaman", "Tanggal Pengembalian", "Denda Keterlambatan"
            }
        ) {
            Class[] types = new Class [] {
        ...
        if (jTable2.getColumnModel().getColumnCount() > 0) {
            jTable2.getColumnModel().getColumn(2).setHeaderValue("Tanggal Pengembalian");
            jTable2.getColumnModel().getColumn(3).setHeaderValue("Denda Keterlambatan");
        }
        ...
        jButton2.setText("Pinjam Barang");
